...
var ClassesMap = (function () {
    ...
    ClassesMap.prototype.groupMethods = function (flatList) {
        var _this = this;
        var variantsDict = _.groupBy(flatList, function (method) {
            return method.name;
        });
        _.forEach(variantsDict, function (variants, name) {
            variantsDict[name] = variants.sort(_this.compareVariants);
        });
        return variantsDict;
    };
    ...
    ClassesMap.prototype.mapClass = function (className, work) {
        ...
        var variants = this.flattenDictionary(variantsDict);
        var classMap = {
