...
var ClassesMap = (function () {
    ...
    ClassesMap.prototype.mapMethod = function (method) {
        ...
        var methodMap = {
            ...
            tsParamTypes: _.map(method.getParameterTypes(), function (p) { return _this.tsTypeName(p.getName()); }),
            tsGenericParamTypes: _.map(method.getGenericParameterTypes(), function (p) { return p.getTypeName(); }),
            isStatic: isStatic,
    ...
    ClassesMap.prototype.mapField = function (field) {
        ...
        var tsType = this.tsTypeName(fieldTypeName, ParamContext.eReturn);
        var tsGenericType = genericFieldType.getTypeName();
    ...
    ClassesMap.prototype.loadClassCache = function () {
        ...
        this.allClasses.forEach(function (className) {
            ...
            var isPublic = _this.Modifier.isPublic(modifiers);
