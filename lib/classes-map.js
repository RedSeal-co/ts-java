...
var ClassesMap = (function () {
    ...
    ClassesMap.prototype.translateFullClassPathsToShortAlias = function (javaGenericType) {
        ...
        while ((m = re.exec(translated)) != null) {
            if (this.isIncludedClass(m[0])) {
                var aliasName = this.getJavaAliasName(m[0]);
    ...
    ClassesMap.prototype.mapMethod = function (method) {
        ...
        var methodMap = {
            ...
            tsGenericParamTypes: _.map(method.getGenericParameterTypes(), function (p) { return _this.translateGenericType(p.getTypeName()); }),
    ...
    ClassesMap.prototype.mapField = function (field) {
        ...
        var tsType = this.tsTypeName(fieldTypeName, ParamContext.eReturn, true);
