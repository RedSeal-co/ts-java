...
var ClassesMap = (function () {
    function ClassesMap(java, includedPatterns, excludedPatterns) {
        ...
        this.fullClassList = Immutable.Set();
    ...
    ClassesMap.prototype.mapClass = function (className, work) {
        ...
        if (isEnum) {
            ...
            var enums = clazz.getEnumConstantsSync();
            enumConstants = _.map(enums, function (e) { return e.toStringSync(); });
        }
        var classMap = {
    ...
    ClassesMap.prototype.getWhitedListedClassesInJar = function (jarpath) {
        ...
        return listArchive(jarpath).then(function (entries) {
            ...
            return _.filter(classNames, function (name) { return _this.inWhiteList(name); });
        });
    };
    ...
    ClassesMap.prototype.preScanAllClasses = function (classpath) {
        var _this = this;
        return BluePromise.reduce(classpath, function (allSoFar, jarpath) {
    ...
    ClassesMap.prototype.initialize = function (seedClasses) {
        ...
        return BluePromise.resolve().then(function () {
            var work1 = _this.loadAllClasses(seedClasses);
            _this.fullClassList = work1.getDone();
            ...
            _this.fullClassList.forEach(function (longName) {
            ...
            _this.classes = {};
            var work2 = _this.loadAllClasses(seedClasses);
            var checkClassList = work2.getDone();
            assert(_this.fullClassList.size === checkClassList.size);
        });
    };
    return ClassesMap;
})();
