...
var ClassesMap = (function () {
    ...
    ClassesMap.prototype.translateGenericType = function (javaGenericType, context) {
        if (context === void 0) { context = ParamContext.eInput; }
    ...
    ClassesMap.prototype.mapClass = function (className, work) {
        ...
        var tsGenericInterfaces = _.map(clazz.getGenericInterfaces(), function (genType) {
            return _this.translateGenericType(genType.getTypeName());
        });
        tsGenericInterfaces = _.filter(tsGenericInterfaces, function (intf) { return intf !== 'any'; });
        ...
        var tsRegularInterfaces = _.map(interfaces, function (intf) { return _this.fixClassPath(intf); });
        ...
        tsRegularInterfaces = _.map(tsRegularInterfaces, function (intf) { return 'Java.' + intf; });
    ...
    ClassesMap.prototype.mapField = function (field) {
        ...
        var tsGenericType = this.translateGenericType(genericFieldType.getTypeName(), ParamContext.eReturn);
