...
var CodeWriter = (function () {
    function CodeWriter(classesMap, templatesDirPath, partialsDirPath) {
    ...
    CodeWriter.prototype.registerPartials = function (partialsDirPath) {
        var extension = '.txt';
    ...
    CodeWriter.prototype.registerHandlebarHelpers = function () {
        ...
        handlebars.registerHelper('classgentypes', function (array, options) {
            if (array.length === 0) {
                return '';
            }
            else {
        ...
        handlebars.registerHelper('methodgentypes', function (method, options) {
        ...
        handlebars.registerHelper('usetypes', function (array, options) {
            if (!generics || array.length === 0) {
                return '';
            }
            else {
                return '<' + _.map(array, function () { return 'any'; }).join(', ') + '>';
            }
        });
    };
