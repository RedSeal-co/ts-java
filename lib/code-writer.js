...
var CodeWriter = (function () {
    ...
    CodeWriter.prototype.streamPackageFile = function (options, streamFn, endFn) {
        var _this = this;
        var context = {
    ...
    CodeWriter.prototype.streamAutoImportFile = function (options, streamFn, endFn) {
        var _this = this;
        ...
        return streamFn('// ' + outputBaseName + '\n').then(function () { return streamFn('// This file was generated by ts-java.\n'); }).then(function () { return streamFn('/// <reference path="' + relativePath + '" />\n\n'); }).then(function () { return streamFn(_this.fill('autoImport', _this.sortedClasses)); }).then(function () { return endFn(); });
    };
