...
var Main = (function () {
    ...
    Main.prototype.writeAutoImport = function () {
        ...
        if (this.options.tsJavaModulePath === undefined) {
            ...
            return mkdirpPromise(path.dirname(this.options.tsJavaModulePath)).then(function () { return tsWriter.writeAutoImportFile(_this.options); }).then(function () { return dlog('writeAutoImport() completed'); });
        }
    };
