...
var Main = (function () {
    ...
    Main.prototype.run = function () {
        var _this = this;
        return this.load().then(function () { return BluePromise.join(_this.writeJsons(), _this.writeInterpolatedFiles(), _this.writeTsJavaModule()); }).then(function () { return dlog('run() completed.'); }).then(function () { return _this.outputSummaryDiagnostics(); }).then(function () { return _this.classesMap; });
    };
    ...
    Main.prototype.writeTsJavaModule = function () {
        ...
        if (this.options.tsJavaModulePath === undefined) {
            ...
            return mkdirpPromise(path.dirname(this.options.tsJavaModulePath)).then(function () { return tsWriter.writeTsJavaModule(_this.options); }).then(function () { return dlog('writeTsJavaModule() completed'); });
        }
    };
