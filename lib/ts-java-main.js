...
var Main = (function () {
    ...
    Main.prototype.run = function () {
        var _this = this;
        return this.load()
            .then(function () { return BluePromise.join(_this.writeJsons(), _this.writeInterpolatedFiles(), _this.writeTsJavaModule()); })
    ...
    Main.prototype.writeClassFiles = function (classesMap) {
        ...
        return mkdirpPromise('o/lib')
            ...
            .then(function (promises) { return BluePromise.all(promises); })
            .then(function () { return dlog('writeClassFiles() completed.'); });
    };
    Main.prototype.writePackageFiles = function (classesMap) {
        ...
        if (!this.options.outputPath) {
            ...
            return mkdirpPromise(path.dirname(this.options.outputPath))
                .then(function () { return tsWriter.writePackageFile(_this.options); })
                .then(function () { return dlog('writePackageFiles() completed'); });
        }
    };
