...
export module Java {
  ...
  export function forEach(javaIterator: Java.Iterator<Java.object_t>, consumer: ConsumeObject): BluePromise<void> {
    function _eachIterator(javaIterator: Java.Iterator<Java.object_t>, consumer: ConsumeObject): BluePromise<void> {
