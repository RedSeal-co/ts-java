...
describe('CodeWriter', () => {
  ...
  describe('streamPackageFile header', () => {
    it('should write a java.d.ts stream with the expected reference paths', () => {
      var className = 'com.redseal.featureset.SomeAbstractClass';
      var runPromise = theWriter.streamPackageFile(options, streamFn, endFn).then(endFn);
      var expectedData = [
        '// java.d.ts',
  ...
  describe('streamAutoImportFile header', () => {
    it('should write a java.d.ts stream with the expected reference paths', () => {
      var className = 'com.redseal.featureset.SomeAbstractClass';
      var runPromise = theWriter.streamAutoImportFile(options, streamFn, endFn).then(endFn);
      var expectedData = [
        '// autoImport.ts',
        '// This file was generated by ts-java.',
